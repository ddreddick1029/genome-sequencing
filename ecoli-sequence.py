...
print('\nThe percentage of As in relation to the entire E. coli file is: ' + str(round(numberofAs /
      (numberofCs + numberofGs + numberofTs + numberofAs) * 100, 2)))

print('\nThe percentage of Cs in relation to the entire E. coli file is: ' + str(round(numberofCs /
      (numberofGs + numberofAs + numberofTs + numberofCs) * 100, 2)))

print('\nThe percentage of Gs in relation to the entire E. Coli file is: ' + str(round(numberofGs /
      (numberofCs + numberofAs + numberofTs + numberofGs) * 100, 2)))

print('\nThe percentage of Ts in relation to the entire E. Coli file is: ' + str(round(numberofTs /
