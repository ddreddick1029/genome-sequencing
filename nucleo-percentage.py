...
print('\nThe percentage of As in relation to the entire E. coli file is: ', numberofAs /
      (numberofCs + numberofGs + numberofTs + numberofAs) * 100, )

print('\nThe percentage of Cs in relation to the entire E. coli file is: ', numberofCs /
      (numberofGs + numberofAs + numberofTs + numberofCs) * 100, )

print('\nThe percentage of Gs in relation to the entire E. Coli file is: ', numberofGs /
      (numberofCs + numberofAs + numberofTs + numberofGs) * 100, )

print('\nThe percentage of Ts in relation to the entire E. Coli file is: ', numberofTs /
